  ...
  return (
    <section className="w-full bg-muted/35 px-6 py-16 sm:px-10 lg:px-28">
      <div className="mx-auto grid w-full max-w-[105rem] grid-cols-1 gap-10 lg:grid-cols-[0.89fr_1.11fr] xl:gap-12">
        <div className="self-start rounded-[1.45rem] bg-[linear-gradient(135deg,oklch(0.68_0.22_31)_0%,oklch(0.86_0.13_78)_56%,oklch(0.47_0.11_108)_100%)] p-8 sm:p-12 lg:p-10 xl:p-16">
        ...
        <div className="flex flex-col gap-6">
          {popularJobs.map((job) => (
            <Card
              key={job.title}
              className="min-h-[8.8rem] justify-between gap-5 rounded-[1rem] border-0 bg-card px-7 py-5 ring-0 sm:px-8"
            >
